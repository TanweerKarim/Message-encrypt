        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">New Message</h1>
                    <div class="row">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                  <form action="compose.php" method="post">
                                    <label for="">To</label><input type="text" class="form-control" name="sendto" value="">
                                    <label for="">Subject</label>
                                    <input type="text" class="form-control" name="subject" value="">
                                    <label for="">Enter Message</label><br>
                                    <textarea class="form-control" name="msg" rows="8" cols="80"></textarea><br>
                                    <button type="submit" class="btn form-control btn-success" name="send">Send message</button>
                                  </form>
                                </div>
                            </div>
                          </div>
...
if(isset($_POST["send"]))
{
  ...
  $end = time();
  $totalt=$end-$start;
  $qur="INSERT INTO `message`(`sendto`, `fromuser`, `subject`, `message`, `msg_date`, `s_key`) VALUES ('{$sendto}','{$usr}','{$subj}','{$encrypted}','{$cdate}','{$encnpy_key}')";
