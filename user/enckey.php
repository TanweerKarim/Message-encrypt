  		...
  		<div class="container">
  			<div class="row justify-content-center">
                ...
                <div class="login-wrap p-4 p-lg-5 order-md-last" style="background-image: linear-gradient(to right, #FFD54F, #D500F9);width:100%;">
    			      	<div class="d-flex">
    			      		<div class="w-100">
    			      			<h3 class="mb-4"><b>Message</b></h3>
    			      		</div>

    			      	</div>
    							<form action="index.php" method="post" class="signin-form">
                    <div class="form-group mb-3">
    			      			<label class="label" for="name">Sender Name</label>
    			      			<input type="text" class="form-control" name="uname" value="Aditya kumar" required>
    			      		</div>
                    <div class="form-group mb-3">
    		            ...
    		            <div class="form-group">
    		            	<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">Delete Message</button>
    		            </div>
    		          </form>
    		        </div>
  		      </div>
