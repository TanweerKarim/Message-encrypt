  		...
  		<div class="container">
  			<div class="row justify-content-center">
                ...
                <div class="login-wrap p-4 p-lg-5 order-md-last" style="background-image: linear-gradient(to right, #FFD54F, #D500F9);width:100%;">
    			      	<div class="d-flex">
    			      		<div class="w-100">
    			      			<h3 class="mb-4">All Messages</h3>
    			      		</div>

    			      	</div>
    							<form action="index.php" method="post" class="signin-form">
    			      		<div class="form-group mb-3">
    			      			<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">One message from <b>Aditya</b></button>
    			      		</div>
    		            <div class="form-group">
    		            	<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">One message from <b>Anna</b></button>
    		            </div>
                    <div class="form-group mb-3">
    			      			<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">One message from <b>Aditya</b></button>
    			      		</div>
    		            <div class="form-group">
    		            	<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">One message from <b>Olivia</b></button>
    		            </div>
                    <div class="form-group mb-3">
    			      			<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">One message from <b>Aditya</b></button>
    			      		</div>
