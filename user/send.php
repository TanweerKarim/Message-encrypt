  ...
  <link rel="stylesheet" href="css/bootstrap.min.css">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
      <div class="container">
        ...
        <!-- Brand -->
        <a class="navbar-brand" href="index.php" style="color:black;" target="_self">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active" style="margin-left:600px;">
              <form action="admin.php" method="post">
                <label style="display:inline-block;"> &nbsp;&nbsp;&nbsp;Aditya Kumar Jha<b> &nbsp;&nbsp;&nbsp;Logout</b></label>
              </form>
            </li>
          </ul>
  		...
  		<div class="container">
  			<div class="row justify-content-center">
                ...
                <div class="login-wrap p-4 p-lg-5 order-md-last" style="background-image: linear-gradient(to right, #FFD54F, #D500F9);width:100%;">
    			      	<div class="d-flex">
    			      		<div class="w-100">
    			      			<h3 class="mb-4"><b>Send Message</b></h3>
    			      		</div>
                    ...
                    <div class="form-group mb-3">
    			      			...
    			      			<input type="text" class="form-control" name="uname" value="__Tanweer_karim" required>
    			      		</div>
                    <div class="form-group mb-3">
    			      			<label class="label" for="name">Enter Message</label>
    			      			<input type="text" class="form-control" name="uname" value="This is to display the use of encryption" style="height:200px;"required>
    			      		</div>
    		            <div class="form-group">
    		            	<button type="submit" name="s1" class="form-control btn btn-primary submit px-3">Send Message</button>
    		            </div>
    		          </form>
    		        </div>
  		      </div>
